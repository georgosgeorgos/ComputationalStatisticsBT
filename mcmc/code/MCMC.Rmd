...
```{r 2.e implementation A/R with conjugate model}
...
```{r 4 Markov Chain for sample size 1000}
# state space
S = c(1,2,3)
...
```{r Alpha, warning=FALSE, eval=FALSE}
...
```{r Beta, warning=FALSE, eval=FALSE}
...
```{r Gamma, warning=FALSE, eval=FALSE}
...
```{r Tau2, warning=FALSE, eval=FALSE}
